    ...
    if response.status_code == 200:
        try:
            ...
            for stat in response_data.get("stats", []):
                ...
                elif name == "agent-console-electron" and active == 0:
                    print("Active for agent-console-electron is 0, proceeding to start deployment.")
                    start_deployment(token, "teran1024/db", "agent-console-electron")
