        ...
        try:
            ...
            for stat in response_data.get("stats", []):
                ...
                if name == "mariadb" and active == 0:
                    ...
                    start_deployment(token, "mariadb")
...
def start_deployment(token, service_name):
    # PUT 요청을 보낼 URL
    url = f"https://api.cloudtype.io/project/teran1024/db/stage/main/deployment/{service_name}/start"
